        ...
        <div class="row">
          <div class="col-md-2">
            <div class="list-group">
              ...
              <a href="<?php echo base_url(); ?>index.php/candidatos_c/index" class="list-group-item">
                 ...
                 </span> Candidatos <span class="badge"> <?php echo count($ido); ?></span>
              </a>
              ...
              </span> Competencias <span class="badge"> <?php echo count($ido); ?></span>
              </a>
              ...
              </span> Capacitacion <span class="badge"> <?php echo count($ido); ?></span>
              </a>
              ...
              </span> Puestos <span class="badge"> <?php echo count($ido); ?></span>
              </a>
              <a href="<?php echo base_url(); ?>index.php/exp_c/index" class="list-group-item">
              <span class="glyphicon glyphicon-comment" aria-hidden="true">
              </span> Experincia <span class="badge"> <?php echo count($ido); ?></span>
              </a>
              ...
              </span> Usuarios <span class="badge"> <?php echo count($ido); ?></span> </a>
            </div>
</div>
         ...
         <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Modificar Idioma</h3>
              </div>
              <div class="panel-body">
                <form method="post" action ="<?php echo base_url();?>index.php/idiomas_c/UpdateIdioma">
                <div class="form-group col-md-2">
                    <label>Id</label>
                    <input type="text" readonly name="id" value="<?php echo $ido->Id_Idioma?>" class="form-control" >
                </div>
                  <div class="form-group col-md-5">
                    <label>Nombre</label>
                    <input  name="nombre" type="text" value="<?php echo $ido->Nombre ?>" class="form-control">
                    <?php echo form_error('nombre'); ?>
                    </div>
                    <div class="form-group col-md-5"">
                    <label for="estado">Estado</label>
                   
                     <select class="custom-select d-block form-control" id="estado" name="estado" placeholder="value="<?php echo $ido->Estado ?>"" required>
                ...
                <?php echo form_error('estado'); ?>
                     ...
                     <a  href="<?php echo base_url(); ?>index.php/idiomas_c/index" type="button" class="btn btn-danger">Cancelar</a>
