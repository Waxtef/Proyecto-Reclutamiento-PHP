        ...
        <div class="row">
          <div class="col-md-2">
            <div class="list-group">
             ...
             <a  href="<?php echo base_url(); ?>index.php/competencias_c/index" type="button" class="btn btn-warning"> <- Volver</a>
             <hr>
         <!-- from para empleado -->
         <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Nuevo Competencia</h3>
              </div>
              <div class="panel-body">
                <form method="post" action ="<?php echo base_url();?>index.php/competencias_c/form_validation">
