        ...
        <div class="row">
          <div class="col-md-2">
            <div class="list-group">
             ...
             <a  href="<?php echo base_url(); ?>index.php/competencias_c/crear" type="button" class="btn btn-success"> + Competencia</a>
             <hr>
         <!-- from para empleado -->
         <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Listado de Competencias</h3>
              </div>
          ...
          "<td>".$c->Descripcion."</td>".
          "<td>".$c->Estado."</td>"
          ."<td><a class=$btn_warning href='modifyCompetencia/".$c->Id_Comp."'><span class=$pencil aria-hidden=$true></span></a>"
          ."<a class=$btn_danger href='DeleteCompetencia/".$c->Id_Comp."'><span class=$ex aria-hidden=$true></span></a></td>"
